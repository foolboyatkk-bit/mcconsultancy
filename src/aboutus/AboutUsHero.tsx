      ...
      <section style={STYLES.section}>
        ...
        >
          ...
          <h1 className="ch-heading text-center" style={STYLES.heading}>
            Guiding Future Doctors <br />
            <span style={STYLES.gradientText}>with Integrity and Expertise</span>
          </h1>
          ...
          <p className="ch-body text-center" style={STYLES.bodyText}>
            With years of experience and a deep commitment to excellence, we help aspiring medical students 
            navigate their journey to top medical universities worldwide. Your success is our mission.
          </p>
