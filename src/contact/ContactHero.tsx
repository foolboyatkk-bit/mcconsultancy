...
const STYLES: Record<string, React.CSSProperties> = {
  ...
  watermark: {
    ...
    top: "-10px",
    right: "-20px",
    fontSize: "clamp(50px, 14vw, 180px)", // Adjusted minimum size for mobile
    fontWeight: 800,
    color: "transparent",
  ...
  mainContent: {
    maxWidth: "1280px",
    margin: "0 auto",
    position: "relative", // Removed fixed padding here
    zIndex: 2,
  },
  breadcrumbWrap: {
    display: "inline-flex",
  ...
  heading: {
    fontSize: "clamp(2rem, 6vw, 3.75rem)", // More fluid clamping
    fontWeight: 700,
    lineHeight: 1.15,
    color: "#0f172a",
    marginBottom: "0",
  ...
  lineShort: { 
    height: "1px", 
    width: "100%", 
    maxWidth: "100px", // Makes this responsive instead of strict 100px
      ...
      <section style={STYLES.section}>
        ...
        <div className="absolute inset-0 opacity-20 pointer-events-none flex items-end justify-center">
          <svg
            ...
            className="w-full min-w-225 h-auto" // Fixed Tailwind class to prevent squishing
            fill="none"
            stroke="#1a3a8f"
            strokeWidth="1.5"
          >
        ...
        >
          ...
          <h1 className="ch-heading text-center" style={STYLES.heading}>
            We're Here to <span style={STYLES.gradientText}>Guide You</span>
            <br />
            on Your <span style={{ color: "#1a3a8f" }}>MBBS Journey</span>
          </h1>
          ...
          <p className="ch-body text-center" style={STYLES.bodyText}>
            ...
            from application to arrival. Your medical career starts here — reach
            out and let's make it happen.
          </p>

          {/* CTA row */}
          <div className="ch-cta" style={STYLES.ctaWrap}>
            <a
              href="#contact-form"
              className="ch-btn-primary rounded-md"
