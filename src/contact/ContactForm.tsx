        ...
        >
          ...
          <div
            ...
            style={{
              ...
              overflow: "hidden",
              boxShadow:
                "0 24px 64px rgba(0,0,0,0.3), 0 4px 16px rgba(0,0,0,0.2)",
            }}
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(160deg, #0f2265 0%, #1a3a8f 50%, #1565c0 100%)",
                display: "flex",
            ...
            >
              ...
              <div>
                ...
                >
                  Reach out for admissions guidance, university selection, or
                  any queries about studying MBBS abroad.
                </p>
              ...
              {submitted ? (
                ...
                <div
                  style={{
                    ...
                    gap: "20px",
                    textAlign: "center",
                    minHeight: "300px", // Ensures panel doesn't collapse on mobile submit
                  }}
                >
                  <div
                    className="cf-check"
