...
import FACULTY_IMG from "../../../assets/countries/northwestern/univ3img3.svg";
import HOSTEL_IMG from "../../../assets/countries/northwestern/hostel.jpeg";
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold mt-3 mb-6">Real-World Medical Training</h2>
