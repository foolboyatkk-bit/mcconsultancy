...
// import HERO_IMG     from "../../../assets/countries/stavropol/hero1.jpg";
...
// ── REUSABLE PRIMITIVES (identical to Volgograd) ───────────────────────────
...
const Stavropol: React.FC = () => {
  ...
  <img
    ...
    className="w-full rounded-2xl object-cover shadow-lg flex-1 min-h-0 max-h-96"
  />
  <img
    src={CEREMONY_IMG}
    alt="Graduation ceremony"
    className="w-full rounded-2xl object-cover shadow-lg flex-1 min-h-0 max-h-80 object-top"
  />
</div>
        </div>
      </section>
      ...
      <section className="max-w-315 mx-auto px-6 sm:px-10 py-20">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <img
            src={CAMPUS_IMG}
            alt="Campus"
            className="w-full rounded-2xl object-cover shadow-lg max-h-140"
          />
        </div>
      </section>

      {/* ══ PG SPECIALTIES (dark section) ══════════════════════════════════ */}
        ...
        <div className="max-w-315 mx-auto px-6 sm:px-10">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <img
              ...
              className="w-full rounded-2xl object-cover shadow-2xl max-h-245"
            />
            <div>
      ...
      <section className="max-w-315 mx-auto px-6 sm:px-10 py-20">
        ...
        <h2 className="text-3xl font-bold text-[#1a237e] mt-3 mb-2">Educational Facilities</h2>
        <Divider />
        ...
        <img
          ...
          className="w-full rounded-2xl object-cover shadow-lg max-h-130"
        />
