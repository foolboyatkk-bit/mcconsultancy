...
const HIGHLIGHTS = [
  { icon: "🎓", title: "WHO & IMC Recognised",     desc: "TPMI's degrees are recognised by the World Health Organization (WHO) and the Indian Medical Council, accepted globally." },
  { icon: "🌍", title: "English Medium",            desc: "Full MBBS program taught in English — no language barrier for Indian and international students." },
  { icon: "🏥", title: "Hands-On Training",         desc: "Modern campus with hands-on medical training and advanced simulation centers to prepare students for real cases." },
  { icon: "🔬", title: "Pediatric Excellence",      desc: "Focused on pediatric medicine, TPMI addresses the unique medical needs of children and leads in pediatrics healthcare across Central Asia." },
  { icon: "📚", title: "Vast Medical Library",      desc: "TPMI's library has a vast medical collection focused on pediatrics and allied sciences with access to the latest research." },
  { icon: "🏠", title: "On-Campus Hostel",          desc: "Comfortable single, double, and triple rooms with study rooms, laundry facilities, and a common kitchen for all students." },
];
      ...
      <section className="relative min-h-[520px] flex flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 w-full pb-16 pt-24">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.08] mb-5 max-w-3xl">
            Tashkent State Medical<br />University (TPMI Campus)
          </h1>
        ...
        <div className="grid md:grid-cols-[1fr_1.7fr] gap-16 items-center">
          <div>
            ...
            <div className="space-y-5 text-[#4b5563] leading-relaxed text-[15.2px]">
              <p>
                The Tashkent Pediatric Medical Institute (TPMI) in Uzbekistan is a leading
                institution. It focuses on pediatric medicine. Established in 1972, TPMI is a top
                center for medical education in Central Asia.
              </p>
              <p>
                It addresses the unique medical needs of children. Over the years, it has gained
                recognition for its strong academics. It offers comprehensive training programs. It
                has made major contributions to pediatrics healthcare in Uzbekistan and beyond.
              </p>
            </div>
            <blockquote className="mt-10 border-l-4 border-[#1976d2] pl-6 text-[#1a237e] italic">
              "A leading centre of pediatric medical education and hands-on clinical training in Central Asia."
            </blockquote>
          </div>
          ...
          <div className="flex h-90 flex-col gap-6">
            <img
              ...
              className="w-full rounded-2xl object-cover shadow-lg h-90"
            />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 py-20">
        ...
        <div className="grid md:grid-cols-[1fr_1.4fr] gap-16 items-center mb-20">
          <div>
            ...
            <p className="text-[#4b5563] leading-relaxed text-base">
              Accredited by the World Health Organization (WHO) and the Indian Medical Council,
              TPMI's degrees are recognized globally, reflecting adherence to the highest standards
          ...
          <img
            src="/univ5img2.jpg"
            alt="TPMI Library"
            className="w-full h-115 rounded-2xl object-cover shadow-lg"
          />
        </div>
        ...
        <div className="grid md:grid-cols-[1.4fr_1fr] gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl font-bold text-[#1a237e] mt-3 mb-6">Library Facilities</h2>
            <Divider />
            <div className="space-y-5 text-[#4b5563] text-base leading-relaxed">
              <p>
                TPMI's library has a vast medical collection. It focuses on pediatrics and allied
                sciences. Students access the latest research. The institute has advanced simulation
                centers. They practice skills before handling real cases. This prepares them for
          ...
          <div className="grid grid-cols-2 gap-5">
            {[
              ...
              <div key={sub} className="rounded-xl border border-[#dbe8f8] bg-[#f8faff] p-5">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div>
              <img
                ...
                className="w-full rounded-2xl object-cover shadow-2xl mb-6 max-h-80"
              />
              <img
                src="/univ5img4.webp"
                alt="TPMI Computer Lab"
                className="w-full rounded-2xl object-cover shadow-2xl max-h-80"
              />
            </div>
            <div>
              ...
              <h2 className="text-3xl font-bold mt-3 mb-8">Hostel Facilities</h2>
              <div className="flex flex-col gap-6">
                {HOSTEL_ROOMS.map(({ title, desc }) => (
                  <div key={title} className="border-l-2 border-[#64b5f6]/50 pl-5">
                    <p className="font-bold text-[#90caf9] text-sm mb-1">{title}</p>
                    <p className="text-white/75 text-[14.5px] leading-relaxed">{desc}</p>
                  </div>
                ))}
              </div>
            </div>
              ...
              <thead>
                <tr className="bg-[#dbeafe]">
                  {YEARLY_HEAD.map((h, i) => (
                    <th
                      key={i}
                      className="border-b border-[#b3cde8] px-6 py-5 text-left font-semibold whitespace-nowrap"
                    >
                      {h}
                    </th>
                  ))}
