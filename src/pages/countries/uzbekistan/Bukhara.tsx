...
const HIGHLIGHTS = [
  { icon: "🎓", title: "WHO & NMC Recognised",     desc: "Degree accepted by National Medical Commission of India, WHO, UNESCO & Ministry of Higher Education of Uzbekistan." },
  { icon: "🌍", title: "English Medium",            desc: "Full MD program taught in English — no language barrier for Indian and international students." },
  { icon: "🏥", title: "Clinical Training",         desc: "Practical training with clinical rotations at affiliated hospitals including Bukhara Regional Multidisciplinary Medical Center." },
  { icon: "🔬", title: "Research Excellence",       desc: "Dedicated to high-quality medical education and fostering research excellence across medicine, dentistry, and pharmacy." },
  { icon: "🏠", title: "Affordable Hostel",         desc: "Best quality hostel facilities for international students at a very affordable cost with comfortable accommodation." },
  { icon: "📋", title: "Great FMGE Results",        desc: "BSMU students consistently achieve great results in FMGE examinations, reflecting the quality of education provided." },
];

const FACULTIES = [
  { num: "01", name: "Faculty of Medicine"                    },
  { num: "02", name: "Faculty of Biomedicine"                 },
  { num: "03", name: "Faculty of International Medicine"      },
  { num: "04", name: "Faculty of Advanced Training for Doctors" },
  { num: "05", name: "Avicenna Faculty of Medicine"           },
];

const RECOGNITIONS = [
  { code: "WHO",     full: "World Health Organization (WHO)"                                         },
  { code: "NMC",     full: "National Medical Commission of India (NMC)"                              },
  { code: "UNESCO",  full: "UNESCO — United Nations Educational, Scientific and Cultural Organization" },
  { code: "MOE",     full: "Ministry of Higher and Secondary Specialized Education of Uzbekistan"    },
];
...
const YEARLY_ROWS = [
  ["2nd Year", "3200$", "400$", "400$", "250$", "4,250$"],
  ["3rd Year", "3200$", "400$", "400$", "250$", "4,250$"],
  ["4th Year", "3200$", "400$", "400$", "250$", "4,250$"],
  ["5th Year", "3200$", "400$", "400$", "250$", "4,250$"],
  ["6th Year", "3200$", "400$", "400$", "250$", "4,250$"],
];
...
const ADMISSION_STEPS = [
  { amount: "Rs. 50,000",   when: "Initial amount — pay directly when applying for the admission." },
  { amount: "Rs. 50,000",   when: "Have to pay after getting the invitation."                      },
  ...
  return (
    <div className="font-['DM_Sans',sans-serif] text-[#1a1a2e] bg-white">
      ...
      <section className="relative min-h-[520px] flex flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 w-full pb-16 pt-24">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.08] mb-5 max-w-3xl">
            Bukhara State<br />Medical University
          </h1>
          <p className="text-white/90 text-xl max-w-xl">
            Great FMGE results and quality infrastructure
          </p>
        </div>

        <div className="absolute right-0 top-0 h-full w-1 bg-gradient-to-b from-transparent via-[#1976d2] to-transparent opacity-60" />
      </section>
        ...
        <div className="grid md:grid-cols-[1fr_1.7fr] gap-16 items-center">
          <div>
            ...
            <h2 className="text-4xl font-bold text-[#1a237e] mt-3 mb-6 leading-tight">
              Premier medical education since 1990
            </h2>
            <Divider />
            <div className="space-y-5 text-[#4b5563] leading-relaxed text-[15.2px]">
              <p>
                Bukhara State Medical University (BSMU), established in 1990, is a premier medical
                institution in Bukhara, Uzbekistan. Named after the renowned Persian polymath Abu Ali
                ibn Sino (Avicenna), BSMU is dedicated to providing high-quality medical education
                and fostering research excellence.
              </p>
              <p>
                The university offers a comprehensive range of undergraduate and postgraduate programs
                in medicine, dentistry, and pharmacy, attracting students from around the globe.
                BSMU's flagship program is the 6-year MD course, which is equivalent to the MBBS
                degree in India.
              </p>
              <p>
                The curriculum is designed to provide a robust foundation in medical sciences,
                clinical skills, and patient care. The medium of instruction is English, making it
                accessible to international students. The university emphasizes practical training,
                with clinical rotations conducted at affiliated hospitals, including the Bukhara
                Regional Multidisciplinary Medical Center and the Bukhara City Clinical Hospital.
              </p>
            </div>
          </div>
          ...
          <div className="flex h-80 flex-col gap-6">
            <img
              src="/univ4img1.svg"
              alt="Bukhara State Medical University building"
              className="w-full  rounded-2xl object-cover shadow-lg h-80"
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f8fbff] py-20">
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          <SectionLabel>Why Choose BSMU</SectionLabel>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-5 text-[#4b5563] text-base leading-relaxed">
              <p>
                Every year, so many students complete their dreams, but students are a little bit
                worried about staying. So, don't worry — Bukhara State University provides the
                best quality hostel facilities for international students at a very affordable cost.
              </p>
              <p>
                Indian students as well as international students who come to pursue their studies
                can get the best accommodation within the university premises.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#f8fbff] py-20">
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          ...
          {/* First Year Package */}
          <div className="rounded-2xl bg-[#dbeafe] border border-[#b3cde8] p-10 text-center mb-4 shadow-sm">
            <p className="text-lg font-semibold tracking-[0.15em] text-[#1a237e] uppercase mb-2">
              First Year Package
            </p>
            <p className="text-4xl font-bold text-[#1a237e]">TOTAL: USD 6,800 $</p>
          </div>

          {/* Payment Terms + Included/Not Included */}
          <div className="rounded-2xl border border-[#b3cde8] bg-white p-8 mb-10 shadow-sm">
            <h3 className="text-lg font-semibold text-[#1a237e] mb-4">Payment Terms</h3>
            <ul className="list-disc list-inside text-[#374151] text-sm space-y-2 mb-8">
              <li>
                <strong>$ 4,000</strong> payable before classes start (approx. September 2025)
              </li>
              <li>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <h4 className="font-semibold text-[#1a237e] mb-3">Not Included:</h4>
                <ul className="list-disc list-inside text-[#374151] text-sm space-y-1.5">
          ...
          {/* Yearly Wise Fees */}
          <h3 className="text-lg font-semibold text-[#1a237e] mb-5">Yearly Wise Fees</h3>
          <div className="overflow-x-auto rounded-2xl border border-[#b3cde8] bg-white mb-4 shadow-sm">
            {/* Header banner */}
            <div className="bg-[#dbeafe] px-6 py-4 text-center font-semibold text-[#1a237e] tracking-widest text-sm border-b border-[#b3cde8]">
              SECOND YEAR ONWARDS
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl border border-[#dbe8f8] p-8 shadow-sm">
              <h3 className="font-bold text-[#1a237e] text-xl mb-2">Admission Procedure:</h3>
              <p className="text-[#4b5563] text-sm mb-5">Needed documents are:</p>
