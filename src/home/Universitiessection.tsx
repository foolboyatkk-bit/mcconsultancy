...
const RUSSIA = [
  {
    ...
    link: "/countries/russia/stavropol" 
  },
  {
    img: volgograd,
    ...
    link: "/countries/russia/volgograd" 
  },
  {
    img: nwsmu,
    ...
    link: "/countries/russia/north-western" 
  },
];
...
const UZBEKISTAN = [
  {
    ...
    link: "/countries/uzbekistan/bukhara" 
  },
  {
    img: asia,
    ...
    link: "/countries/uzbekistan/asia" 
  },
];
...
const UniCard = ({ img, name, country, desc, link }: UniCardProps) => (
  <div className="group bg-white rounded-[20px] p-3 flex flex-col h-full transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_16px_40px_rgba(29,78,216,0.18)]">
    {/* Image */}
    <div className="relative w-full rounded-[14px] overflow-hidden bg-slate-100 shrink-0 h-48 sm:h-52 lg:h-[220px]">
      <img
        src={img}
        alt={name}
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#1a2472]/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
    ...
    <div className="flex flex-col flex-1 px-3 sm:px-4 py-5 sm:py-6">
      ...
      <div className="w-8 h-0.5 bg-gradient-to-r from-[#1D4ED8] to-[#60A5FA] mb-4 transition-all duration-500 group-hover:w-20 rounded-full" />
      <p className="text-sm text-slate-500 leading-relaxed flex-1">{desc}</p>
      
      {/* Link (Use <Link href={link}> if using Next.js) */}
      <a href={link} className="mt-5 w-fit flex items-center gap-1.5 text-[#1D4ED8] text-sm font-semibold opacity-0 -translate-x-3 transition-all duration-500 group-hover:opacity-100 group-hover:translate-x-0 cursor-pointer">
        Learn more
...
const UniCardHorizontal = ({ img, name, country, desc, link, index }: UniCardProps & { index: number }) => (
  <div className="group bg-white rounded-[20px] overflow-hidden flex flex-col sm:flex-row transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(21,128,61,0.15)]">
    ...
    <div className="relative w-full sm:w-[38%] lg:w-[32%] shrink-0 overflow-hidden bg-slate-100 h-56 sm:h-auto sm:min-h-[240px] lg:min-h-[260px]">
      <img
        src={img}
        alt={name}
        className="w-full h-full object-cover transition-transform duration-700 ease-out group-hover:scale-110"
      ...
      />
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-t sm:bg-gradient-to-r from-transparent to-black/10 sm:to-black/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      <div className="absolute top-3 left-3 sm:top-4 sm:left-4">
        <CountryPill country={country} />
      </div>
      {/* Index badge */}
      <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 w-8 h-8 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center text-[#15803D] text-xs font-black shadow-md">
        0{index + 1}
      </div>
    </div>
    ...
    <div className="flex flex-col flex-1 p-5 sm:p-7 lg:p-9 justify-center">
      ...
      <div className="w-10 h-0.5 bg-gradient-to-r from-[#15803D] to-[#34D399] mb-4 transition-all duration-500 group-hover:w-24 rounded-full" />
      <p className="text-sm sm:text-base text-slate-500 leading-relaxed max-w-xl">{desc}</p>

      {/* CTA row */}
      <div className="mt-6 flex items-center gap-4">
        {/* Link (Use <Link href={link}> if using Next.js) */}
        <a href={link} className="flex items-center gap-1.5 text-[#1D4ED8] text-sm font-semibold opacity-100 sm:opacity-0 sm:-translate-x-3 transition-all duration-500 sm:group-hover:opacity-100 sm:group-hover:translate-x-0 cursor-pointer">
          Learn more
          <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-blue-50 text-xs">→</span>
        </a>
...
const SectionDivider = ({
  ...
  <AnimatedElement
    delay={delay}
    className="flex flex-wrap items-center justify-between gap-4 pb-4 mb-8 sm:mb-10"
  >
    ...
    <div className="flex items-center gap-2">
      ...
      <span className="text-blue-300 text-xs sm:text-sm font-medium bg-blue-400/10 px-3 py-1 rounded-full border border-blue-400/20 whitespace-nowrap">
        {count}
      </span>
    </div>
  </AnimatedElement>
...
const UniversitiesSection = () => (
  <>
    ...
    >
      {/* Background glows */}
      <div className="bg-glow absolute top-0 left-1/2 w-[min(900px,100vw)] h-[32rem] sm:h-[40rem] bg-[#1D4ED8] blur-[120px] sm:blur-[160px] rounded-full pointer-events-none" />
      <div className="bg-orb absolute bottom-10 -right-20 w-64 h-64 sm:w-96 sm:h-96 bg-[#1D4ED8] opacity-15 blur-[80px] sm:blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <AnimatedElement className="mb-12 sm:mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight mb-4 sm:mb-5">
        ...
        <div className="mb-12 sm:mb-16 lg:mb-24">
          <div className="divider-line mb-15 sm:mb-20">
